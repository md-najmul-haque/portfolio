...
const Skills = () => {
    ...
    return (
        ...
        <div className='py-10 '>
            <h2 className='text-5xl text-center font-bold mb-5'><span className='text-white'>My</span> <span className='text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent'>Skills</span></h2>
            <div data-aos="fade-up" data-aos-duration="1500" className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 px-12 text-white'>
                {skills.map(skill => (
